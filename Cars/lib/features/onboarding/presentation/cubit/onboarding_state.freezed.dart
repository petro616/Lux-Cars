...
mixin _$OnboardingState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<OnboardingEntites> data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<OnboardingEntites> data)? loaded,
...
abstract class _$$LoadedImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({List<OnboardingEntites> data});
}
...
class _$LoadedImpl<T> implements Loaded<T> {
  _$LoadedImpl(final List<OnboardingEntites> data) : _data = data;

  final List<OnboardingEntites> _data;
  @override
  List<OnboardingEntites> get data {
...
abstract class Loaded<T> implements OnboardingState<T> {
  factory Loaded(final List<OnboardingEntites> data) = _$LoadedImpl<T>;
